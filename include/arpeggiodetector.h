...
const std::map<Note, double> target_notes = {
    // Octave 0
    {Note::C0, 16.35}, {Note::D_FLAT0, 17.32}, {Note::D0, 18.35}, {Note::E_FLAT0, 19.45},
    {Note::E0, 20.60}, {Note::F0, 21.83}, {Note::G_FLAT0, 23.12}, {Note::G0, 24.50},
    {Note::A_FLAT0, 25.96}, {Note::A0, 27.50}, {Note::B_FLAT0, 29.14}, {Note::B0, 30.87},
    // Octave 1
    {Note::C1, 32.70}, {Note::D_FLAT1, 34.65}, {Note::D1, 36.71}, {Note::E_FLAT1, 38.89},
    {Note::E1, 41.20}, {Note::F1, 43.65}, {Note::G_FLAT1, 46.25}, {Note::G1, 49.00},
    {Note::A_FLAT1, 51.91}, {Note::A1, 55.00}, {Note::B_FLAT1, 58.27}, {Note::B1, 61.74},
    // Octave 2
    {Note::C2, 65.41}, {Note::D_FLAT2, 69.30}, {Note::D2, 73.42}, {Note::E_FLAT2, 77.78},
    {Note::E2, 82.41}, {Note::F2, 87.31}, {Note::G_FLAT2, 92.50}, {Note::G2, 98.00},
    {Note::A_FLAT2, 103.83}, {Note::A2, 110.00}, {Note::B_FLAT2, 116.54}, {Note::B2, 123.47},
    // Octave 3
    {Note::C3, 130.81}, {Note::D_FLAT3, 138.59}, {Note::D3, 146.83}, {Note::E_FLAT3, 155.56},
    {Note::E3, 164.81}, {Note::F3, 174.61}, {Note::G_FLAT3, 185.00}, {Note::G3, 196.00},
    {Note::A_FLAT3, 207.65}, {Note::A3, 220.00}, {Note::B_FLAT3, 233.08}, {Note::B3, 246.94},
    // Octave 4
    {Note::C4, 261.63}, {Note::D_FLAT4, 277.18}, {Note::D4, 293.66}, {Note::E_FLAT4, 311.13},
    {Note::E4, 329.63}, {Note::F4, 349.23}, {Note::G_FLAT4, 369.99}, {Note::G4, 392.00},
    {Note::A_FLAT4, 415.30}, {Note::A4, 440.00}, {Note::B_FLAT4, 466.16}, {Note::B4, 493.88},
    // Octave 5
